...
const BookPopup: React.FC<BookPopupProps> = ({ isOpen, onClose }) => {
  ...
  return (
    <div className={`fixed top-0 left-0 w-full h-full flex items-center justify-center bg-black bg-opacity-50 transition-opacity duration-500 ${visible ? "opacity-100" : "opacity-0"}`}>
      <div className="bg-white p-6 rounded-lg shadow-2xl max-w-md w-full relative transform transition-all duration-500 scale-95">
        {/* Close Button */}
        ...
        {/* Content */}
        <h2 className="text-2xl font-bold text-center text-red-600">WAIT! BEFORE YOU GO...</h2>
